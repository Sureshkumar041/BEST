...
onEdit = (row) => {
    ...
    // document.queryCommandValue("pagination").style="-1";
    var data = JSON.parse(localStorage.getItem("UserData"));
...
onSearch = () => {
    console.log("Dummy: ",dummy[0].cells[0]);
    var inputemail, inputnumber, td, i, txtValue;
    console.log("Data: ", data);
    inputemail = document.getElementById("emailsearch").value.toUpperCase();
    inputnumber = document.getElementById("nosearch").value.toUpperCase();
    tbody.innerHTML = "";
    if (inputemail != "") {
        for (i = 0; i < dummy.length; i++) {
            ...
            if (td) {
                ...
                if (txtValue.toUpperCase().indexOf(inputemail) > -1) {
        ...
        for (i = 0; i < dummy.length; i++) {
            ...
            if (td) {
                txtValue = td.textContent || td.innerText;
                if (txtValue.toUpperCase().indexOf(inputnumber) > -1) {
                    tbody.appendChild(dummy[i]);
                } else {
                    dummy[i].style.display = "none";
                }
...
// onSearch = () => {
//     document.getElementById("searchinputemail").style.visibility = "visible";
//     document.getElementById("searchinputno").style.visibility = "visible";
// }
